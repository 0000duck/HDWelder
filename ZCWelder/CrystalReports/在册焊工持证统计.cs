...
namespace ZCWelder.CrystalReports {
    ...
    public class 在册焊工持证统计 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ZCWelder.CrystalReports.在册焊工持证统计.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached在册焊工持证统计 : Component, ICachedReport {
        
        public Cached在册焊工持证统计() {
        }
