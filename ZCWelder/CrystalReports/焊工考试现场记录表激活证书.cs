...
namespace ZCWelder.CrystalReports {
    ...
    public class 焊工考试现场记录表激活证书 : ReportClass {
        
        public 焊工考试现场记录表激活证书() {
        }
        
        public override string ResourceName {
            get {
                return "焊工考试现场记录表激活证书.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ZCWelder.CrystalReports.焊工考试现场记录表激活证书.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached焊工考试现场记录表激活证书 : Component, ICachedReport {
        
        public Cached焊工考试现场记录表激活证书() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            焊工考试现场记录表激活证书 rpt = new 焊工考试现场记录表激活证书();
            rpt.Site = this.Site;
            return rpt;
        }
