...
namespace ZCWelder.CrystalReports {
    ...
    public class 焊工考试结果登记表 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ZCWelder.CrystalReports.焊工考试结果登记表.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached焊工考试结果登记表 : Component, ICachedReport {
        
        public Cached焊工考试结果登记表() {
        }
